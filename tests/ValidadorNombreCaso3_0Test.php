...
class ValidadorNombreCaso3_0Test extends TestCase
{
    ...
    {
        $errores = $this->validador->validarConErrores("juanperez");
    ...
    public function testSeparadoresConsecutivos()
    {
        ...
        $this->assertContains("El nombre no puede contener separadores consecutivos.", $errores);
    }
    ...
    {
        $errores = $this->validador->validarConErrores("user");
    ...
    /** -----------------------------------------
     *  PRUEBA ADICIONAL: NOMBRE VÁLIDO CON GUION
     * ----------------------------------------- */

    public function testNombreValidoConGuion()
    {
        $this->assertTrue($this->validador->validar("juan-perez"));
    }

    /** -----------------------------------------
     *  PRUEBA ADICIONAL: NOMBRE EXACTAMENTE EN LIMITE
     * ----------------------------------------- */

    public function testNombreEnLimite()
    {
        // 20 caracteres exactos
        $nombre = "abcdefghijklmnopqrst";
        $this->assertTrue($this->validador->validar($nombre));
    }
}